...
public class OVRGrabbable : MonoBehaviour
{
    ...
    /// <summary>デフォルトのシェーダー</summary>
    public Shader _DefaultShader = default;

    /// <summary>シェーダーを切り替えるかどうか</summary>
    public bool AllowSwitchShader = true;
    ...
    protected virtual void Start()
    {
        ...
        if(GetComponent<Renderer>()) _DefaultShader = GetComponent<Renderer>().material.shader;
    }
